...
1. Feat Commits that add, adjust or remove a feature to/of/from the API or UI

Example: git commit -m "feat: xxxxxx"
...
1. Always lowercase.
2. Dash "-" as space.
3. firstname-type-header.

Example: jihad-feat-endpoints
